<?php
	...
	----------*/
	const SERVERURL="http://localhost/UT/";
	...
	----------*/
	const SESSION_NAME="UTSC";


	/*----------  Redes sociales - Social networks  ----------*/
	const FACEBOOK="https://www.facebook.com/UTStaCatarina";
	const INSTAGRAM="";
	const YOUTUBE="https://www.youtube.com/user/UTSantaCatarina";
	const TWITTER="";


	/*----------  Direccion - Address  ----------*/
	const COUNTRY="México";
	const ADDRESS="Monterrey, Nuevo Leon, Norte america";
